...
import static com.elpidoroun.financialportfolio.converters.CurrencyConverter.toDomain;
import static com.elpidoroun.financialportfolio.converters.CurrencyConverter.toDto;
...
public class CurrencyConverterTest {
    ...
    public void to_domain_with_unsupported_currency_dto() {
        assertThatThrownBy(() -> CurrencyConverter.toDomain(CurrencyDto.valueOf("CAD")))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("No enum constant")
