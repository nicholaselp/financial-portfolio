...
import static com.elpidoroun.security.auth.AuthenticationController.AUTHENTICATE_URL;
import static com.elpidoroun.security.auth.AuthenticationController.AUTH_URL;
import static com.elpidoroun.security.auth.AuthenticationController.REGISTER_URL;
...
public class AuthenticationControllerTest extends SpringTestsHelper {
    ...
    public void success_register_user() throws Exception {
        MvcResult result = mockMvc().perform(post(AUTH_URL + REGISTER_URL)
                        ...
                        .content(objectMapper.writeValueAsString(RegisterRequestTestFactory.createReqisterRequestForUser())))
