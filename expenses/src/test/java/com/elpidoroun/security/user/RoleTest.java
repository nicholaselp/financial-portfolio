...
import static com.elpidoroun.security.user.Permissions.EXPENSE_CATEGORY_CREATE;
import static com.elpidoroun.security.user.Permissions.EXPENSE_CATEGORY_DELETE;
import static com.elpidoroun.security.user.Permissions.EXPENSE_CATEGORY_READ;
import static com.elpidoroun.security.user.Permissions.EXPENSE_CATEGORY_UPDATE;
import static com.elpidoroun.security.user.Permissions.EXPENSE_CREATE;
import static com.elpidoroun.security.user.Permissions.EXPENSE_DELETE;
import static com.elpidoroun.security.user.Permissions.EXPENSE_READ;
import static com.elpidoroun.security.user.Permissions.EXPENSE_UPDATE;
